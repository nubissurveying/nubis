...
class SingleColumnTableTemplate extends TableTemplate {
    ...
    function singleColumn() {
        ...
        if ($pt != $this->group->getTemplate()) {
            $returnStr .= '<table id="' . $id . '" class="table' . $this->striped . $this->bordered . $this->hovered . $this->condensed . ' uscic-table-singlecolumn">';
        ...
        for ($i = 0; $i < sizeof($this->variables); $i++) {
            ...
            if (startsWith($variable, ROUTING_IDENTIFY_SUBGROUP)) {
                ...
                if ($this->engine->isInlineField($variable) == false) {
                    ...
                    /* question text */
                    $returnStr .= "<tr><td class='uscic-table-row-cell-singlecolumn' >" . $this->displayobject->showQuestionText($variable, $var, "uscic-question-table-row");
                    ...
                    if (!inArray($var->getAnswerType(), array(ANSWER_TYPE_NONE, ANSWER_TYPE_SECTION))) {
                        ...
                        $returnStr .= $this->displayobject->showAnswer($cnt, $variable, $var, $previousdata) . "</td>";
                    }
                    $returnStr .= "</tr>";
                }
            }
