...
var BFHLanguagesListWithCountries = {
    
};

BFHLanguagesListWithCountries['en_US'] = {'name': 'English', 'country': 'US', 'value': 1};
BFHLanguagesListWithCountries['om'] = {'name': 'Afaan Oromo', 'country': 'ET', 'value': 2};
BFHLanguagesListWithCountries['aa'] = {'name': 'Afaraf', 'country': 'ER', 'value': 3};
BFHLanguagesListWithCountries['af'] = {'name': 'Afrikaans', 'country': 'SA', 'value': 4};
BFHLanguagesListWithCountries['ak'] = {'name': 'Akan', 'country': 'GH', 'value': 5};
BFHLanguagesListWithCountries['an'] = {'name': 'aragonés', 'country': 'ES', 'value': 6};
BFHLanguagesListWithCountries['ig'] = {'name': 'Asụsụ Igbo', 'country': 'NG', 'value': 7};
BFHLanguagesListWithCountries['gn'] = {'name': 'Avañe\'ẽ', 'country': 'PY', 'value': 8};
BFHLanguagesListWithCountries['ae'] = {'name': 'avesta', 'country': 'IR', 'value': 9};
BFHLanguagesListWithCountries['ay'] = {'name': 'aymar aru', 'country': 'BO', 'value': 10};
BFHLanguagesListWithCountries['az'] = {'name': 'azərbaycan dili', 'country': 'AZ', 'value': 11};
BFHLanguagesListWithCountries['id'] = {'name': 'Bahasa Indonesia', 'country': 'ID', 'value': 12};
BFHLanguagesListWithCountries['ms'] = {'name': 'bahasa Melayu', 'value': 13}; // 'country': 'SG', 
BFHLanguagesListWithCountries['bm'] = {'name': 'bamanankan', 'country': 'ML', 'value': 14};
BFHLanguagesListWithCountries['jv'] = {'name': 'basa Jawa', 'country': 'ID', 'value': 15};
BFHLanguagesListWithCountries['su'] = {'name': 'Basa Sunda', 'country': 'ID', 'value': 16};
BFHLanguagesListWithCountries['bi'] = {'name': 'Bislama', 'country': 'VU', 'value': 17};
BFHLanguagesListWithCountries['bs'] = {'name': 'bosanski jezik', 'country': 'BA', 'value': 18};
BFHLanguagesListWithCountries['br'] = {'name': 'brezhoneg', 'country': 'FR', 'value': 19};
BFHLanguagesListWithCountries['ca'] = {'name': 'català', 'country': 'ES', 'value': 20};
BFHLanguagesListWithCountries['ch'] = {'name': 'Chamoru', 'country': 'US', 'value': 21};
BFHLanguagesListWithCountries['ny'] = {'name': 'chiCheŵa', 'country': 'MW', 'value': 22};
BFHLanguagesListWithCountries['sn'] = {'name': 'chiShona', 'country': 'MZ', 'value': 23};
BFHLanguagesListWithCountries['co'] = {'name': 'corsu', 'country': 'FR', 'value': 24};
BFHLanguagesListWithCountries['cy'] = {'name': 'Cymraeg', 'country': 'GB', 'value': 25};
BFHLanguagesListWithCountries['da'] = {'name': 'dansk', 'country': 'DK', 'value': 26};
BFHLanguagesListWithCountries['se'] = {'name': 'Davvisámegiella', 'country': 'NO', 'value': 27};
BFHLanguagesListWithCountries['de'] = {'name': 'Deutsch', 'country': 'DE', 'value': 28};
BFHLanguagesListWithCountries['nv'] = {'name': 'Diné bizaad', 'country': 'US', 'value': 29};
BFHLanguagesListWithCountries['de'] = {'name': 'Deutsch', 'country': 'DE', 'value': 30};
BFHLanguagesListWithCountries['et'] = {'name': 'eesti', 'country': 'EE', 'value': 31};
BFHLanguagesListWithCountries['na'] = {'name': 'Ekakairũ Naoero', 'country': 'NR', 'value': 32};
BFHLanguagesListWithCountries['en'] = {'name': 'English', 'country': 'GB', 'value': 33};
BFHLanguagesListWithCountries['es'] = {'name': 'español', 'country': 'ES', 'value': 34};
BFHLanguagesListWithCountries['eo'] = {'name': 'Esperanto', 'value': 35}; // 'country': '',
BFHLanguagesListWithCountries['ee'] = {'name': 'Eʋegbe', 'country': 'TG', 'value': 36};
BFHLanguagesListWithCountries['to'] = {'name': 'faka Tonga', 'country': 'TO', 'value': 37};
BFHLanguagesListWithCountries['mg'] = {'name': 'fiteny malagasy', 'country': 'MG', 'value': 38};
BFHLanguagesListWithCountries['fr'] = {'name': 'français', 'country': 'FR', 'value': 39};
BFHLanguagesListWithCountries['fy'] = {'name': 'Frysk', 'country': 'NL', 'value': 40};
BFHLanguagesListWithCountries['ff'] = {'name': 'Fulfulde', 'country': 'FR', 'value': 41};
BFHLanguagesListWithCountries['fo'] = {'name': 'føroyskt', 'country': 'FO', 'value': 42};
BFHLanguagesListWithCountries['gy'] = {'name': 'Gaeilge', 'country': 'IE', 'value': 43};
BFHLanguagesListWithCountries['sm'] = {'name': 'gagana fa\'a Samoa', 'country': 'WS', 'value': 44};
BFHLanguagesListWithCountries['gl'] = {'name': 'galego', 'country': 'ES', 'value': 45};
BFHLanguagesListWithCountries['sq'] = {'name': 'gjuha shqipe', 'value': 46}; // 'country': ''
BFHLanguagesListWithCountries['gd'] = {'name': 'Gàidhlig', 'country': 'GB', 'value': 47};
BFHLanguagesListWithCountries['ki'] = {'name': 'Gĩkũyũ', 'country': 'KE', 'value': 48};
BFHLanguagesListWithCountries['ha'] = {'name': 'Hausa', 'country': 'EH', 'value': 49};
BFHLanguagesListWithCountries['ho'] = {'name': 'Hiri Motu', 'country': 'PG', 'value': 50};
BFHLanguagesListWithCountries['hr'] = {'name': 'hrvatski jezik', 'country': 'HR', 'value': 51};
BFHLanguagesListWithCountries['io'] = {'name': 'Ido', 'value': 52}; // 'country': 'EH', 
BFHLanguagesListWithCountries['rw'] = {'name': 'Ikinyarwanda', 'country': 'RW', 'value': 53};
BFHLanguagesListWithCountries['rn'] = {'name': 'Ikirundi', 'country': 'BI', 'value': 54};
BFHLanguagesListWithCountries['ia'] = {'name': 'Interlingua', 'value': 55}; //'country': 'EH', 
BFHLanguagesListWithCountries['nd'] = {'name': 'isiNrebele', 'country': 'ZA', 'value': 56};
BFHLanguagesListWithCountries['nr'] = {'name': 'isiNdebele', 'country': 'ZW', 'value': 57};
BFHLanguagesListWithCountries['xh'] = {'name': 'isiXhosa', 'country': 'ZA', 'value': 58};
BFHLanguagesListWithCountries['zu'] = {'name': 'isiZulu', 'country': 'ZA', 'value': 59};
BFHLanguagesListWithCountries['it'] = {'name': 'italiano', 'country': 'IT', 'value': 60};
BFHLanguagesListWithCountries['ik'] = {'name': 'Iñupiaq', 'country': 'US', 'value': 61};
BFHLanguagesListWithCountries['pl'] = {'name': 'polski', 'country': 'PL', 'value': 62};
BFHLanguagesListWithCountries['mh'] = {'name': 'Kajin M̧ajeļ', 'country': 'MH', 'value': 63};
BFHLanguagesListWithCountries['kl'] = {'name': 'kalaallisut', 'country': 'GL', 'value': 64};
BFHLanguagesListWithCountries['kr'] = {'name': 'Kanuri', 'country': 'CM', 'value': 65};
BFHLanguagesListWithCountries['kw'] = {'name': 'Kernewek', 'country': 'GB', 'value': 66};
BFHLanguagesListWithCountries['kg'] = {'name': 'KiKongo', 'country': 'CG', 'value': 67};
BFHLanguagesListWithCountries['sw'] = {'name': 'Kiswahili', 'country': 'TZ', 'value': 68};
BFHLanguagesListWithCountries['ht'] = {'name': 'Kreyòl ayisyen', 'country': 'HT', 'value': 69};
BFHLanguagesListWithCountries['kj'] = {'name': 'Kuanyama', 'country': 'AO', 'value': 71};
BFHLanguagesListWithCountries['ku'] = {'name': 'Kurdî', 'value': 72}; // 'country': 'TZ', 
BFHLanguagesListWithCountries['la'] = {'name': 'latine', 'value': 73}; // 'country': 'TZ', 
BFHLanguagesListWithCountries['lv'] = {'name': 'latviešu valoda', 'country': 'LV', 'value': 74};
BFHLanguagesListWithCountries['lt'] = {'name': 'lietuvių kalba', 'country': 'LT', 'value': 75};
BFHLanguagesListWithCountries['ro'] = {'name': 'limba română', 'country': 'RO', 'value': 76};
BFHLanguagesListWithCountries['li'] = {'name': 'Limburgs', 'country': 'NL', 'value': 77};
BFHLanguagesListWithCountries['ln'] = {'name': 'Lingála', 'country': 'CD', 'value': 78};
BFHLanguagesListWithCountries['lg'] = {'name': 'Luganda', 'country': 'UG', 'value': 79};
BFHLanguagesListWithCountries['lb'] = {'name': 'Lëtzebuergesch', 'country': 'UG', 'value': 80};
BFHLanguagesListWithCountries['hu'] = {'name': 'magyar', 'country': 'UG', 'value': 81};
BFHLanguagesListWithCountries['mt'] = {'name': 'Malti', 'country': 'MT', 'value': 82};
BFHLanguagesListWithCountries['nl'] = {'name': 'Nederlands', 'country': 'NL', 'value': 83};
BFHLanguagesListWithCountries['no'] = {'name': 'Norsk', 'country': 'NO', 'value': 84};
BFHLanguagesListWithCountries['nb'] = {'name': 'Norsk bokmål', 'country': 'NO', 'value': 85};
BFHLanguagesListWithCountries['nn'] = {'name': 'Norsk nynorsk', 'country': 'NO', 'value': 86};
BFHLanguagesListWithCountries['uz'] = {'name': 'O\'zbek', 'country': 'UZ', 'value': 87};
BFHLanguagesListWithCountries['oc'] = {'name': 'occitan', 'country': 'MC', 'value': 88};
BFHLanguagesListWithCountries['ie'] = {'name': 'Interlingue', 'value': 89}; // 'country': 'UG', 
BFHLanguagesListWithCountries['oc'] = {'name': 'occitan', 'country': 'MC', 'value': 90};
BFHLanguagesListWithCountries['hz'] = {'name': 'Otjiherero', 'country': 'NA', 'value': 91};
BFHLanguagesListWithCountries['ng'] = {'name': 'Owambo', 'country': 'MC', 'value': 92};
BFHLanguagesListWithCountries['pt'] = {'name': 'português', 'country': 'AO', 'value': 93};
BFHLanguagesListWithCountries['ty'] = {'name': 'Reo Tahiti', 'country': 'PF', 'value': 94};
BFHLanguagesListWithCountries['rm'] = {'name': 'rumantsch grischun', 'value': 95}; // 
BFHLanguagesListWithCountries['qu'] = {'name': 'Runa Simi', 'country': 'PE', 'value': 96};
BFHLanguagesListWithCountries['sc'] = {'name': 'sardu', 'country': 'IT', 'value': 97};
BFHLanguagesListWithCountries['za'] = {'name': 'Saɯ cueŋƅ', 'country': 'CN', 'value': 98};
BFHLanguagesListWithCountries['st'] = {'name': 'Sesotho', 'country': 'ZA', 'value': 99};
    ...
    BFHLanguages.prototype = {
        ...
        getLanguages: function() {
            ...
            if (this.options.available) {
                ...
                return BFHLanguagesListWithCountries;
            }
        },
                ...
                if (languages.hasOwnProperty(language)) {
                    if (languages[language].hasOwnProperty('name')) { 
                        ...
                        if (this.options.flags === true) {           
                            ...
                            this.$element.append('<option data-icon="bfh-flag-' + languages[language].country + '" value="' + languages[language].value + '">' + languages[language].name.toProperCase() + ' (' + BFHCountriesList[languages[language].country] + ')</option>');
                        } else {
                            this.$element.append('<option value="' + languages[language].value + '">' + languages[language].name.toProperCase() + ' (' + BFHCountriesList[languages[language].country] + ')</option>');
                        }
                    } else {
                        if (this.options.flags === true) { 
                            this.$element.append('<option data-icon="bfh-flag-' + languages[language].country + '" value="' + language + '">' + languages[language].toProperCase() + '</option>');
                        }
                        else {
                            this.$element.append('<option value="' + languages[language].value + '">' + languages[language].toProperCase() + '</option>');
                        }
                    }
                }
            }
